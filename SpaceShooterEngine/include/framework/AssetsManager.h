...
namespace SpaceShooter {
    ...
    public:
        ...
        Shared<Sound> GetSound(const std::string &path);
    ...
    template<typename T>
    Shared<T> AssetsManager::LoadAsset(const std::string &path, Dictionary<std::string, Shared<T> > &container,
                                       T (*loadAssetPtr)(const char *)) {
